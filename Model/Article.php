...
class Article extends Article_parent
{
    ...
    {
        /* @var EmosItem */
        $oEmosItem = oxNew(\Itratos\Oxid\ItrAnalytics\Model\EmosItem::class);
    ...
    public function getGoogleItem($iQuantity = 1)
    {
        ...
        $oGoogleItem = oxNew(\Itratos\Oxid\ItrAnalytics\Model\GoogleItem::class);
    ...
    public function getTrackingProductNumber()
    {
        ...
        $iCol = 0;
        if ($iTmpCol = $oConfig->getConfigParam('itr_analytics_general_artnum')) {
            $iCol = $iTmpCol;
        }
